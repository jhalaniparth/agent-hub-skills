...
The output must read as a user describing an agent to Joule Studio — not as instructions
written directly to the agent. Start with "I want to create an agent." and use
"The agent should..." throughout. Never write "You are..." or address the agent as "you".
